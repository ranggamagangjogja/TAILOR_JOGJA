      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">Tambahkan testimonial pelanggan baru</p>
          </div>
          <Link
            to="/admin/testimoni"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setTestimonial({ ...testimonial, rating: isNaN(value) ? 5 : value });
                              if (errors.rating) setErrors({ ...errors, rating: '' });
                            }}
                          />
                        ...
                        <span className="text-sm text-gray-600">
                          Nilai saat ini: <span className="font-bold text-amber-600">{testimonial.rating || 5}/5</span>
                        </span>
                      </div>
                      {errors.rating && (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-6 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                  <h2 className="text-xl font-semibold text-gray-800">Simpan Testimonial</h2>
                  <p className="text-sm text-gray-600 mt-1">Pastikan semua informasi sudah benar</p>
                </div>
                    ...
                    <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <p className="text-sm text-red-700">
                          Silakan perbaiki {Object.keys(errors).length} kesalahan sebelum menyimpan
                        </p>
                      </div>
                    </div>
                  )}
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-lg p-4">
                <h3 className="font-medium text-gray-900 mb-3">Status Form</h3>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Nama:</span>
                    <span className={`text-sm font-medium ${testimonial.name ? 'text-green-600' : 'text-red-600'}`}>
                      {testimonial.name ? '✓ Terisi' : '✗ Belum'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Teks Testimonial:</span>
                    <span className={`text-sm font-medium ${testimonial.text ? 'text-green-600' : 'text-red-600'}`}>
                      {testimonial.text ? '✓ Terisi' : '✗ Belum'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Rating:</span>
                    <span className="text-sm font-medium text-amber-600">{testimonial.rating || 5}/5</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Foto Profil:</span>
                    <span className="text-sm font-medium text-gray-600">
                      {testimonial.image ? '✓ Ada' : 'Tidak ada'}
                    </span>
                  </div>
                </div>
              </div>
